        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <section className="space-y-5">
            ...
            <section className="grid grid-cols-3 gap-3">
              {/* Campo Tamanho */}
              <article className="bg-white rounded-2xl shadow-md p-3 flex flex-col items-center justify-between aspect-square focus-within:ring-2 focus-within:ring-[#6d8a44] transition-all relative">
                <label htmlFor="tamanho" className="text-xs font-bold text-gray-800 mt-1 uppercase">{unidadeDisplay}</label>
                <input 
                   id="tamanho"
                   name="tamanho"
                   type="number"
                   ...
                   onChange={handleChange}
                   className="w-full text-3xl font-bold text-[#6d8a44] text-center bg-transparent outline-none border-b-2 border-transparent focus:border-[#6d8a44]/50 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                />
                <span className="text-[10px] text-gray-400 absolute bottom-2">editar</span>
              </article>
              ...
              <article className="bg-white rounded-2xl shadow-md p-3 flex flex-col items-center justify-between aspect-square">
                ...
                <button 
                  onClick={() => goTo('COLLABORATORS')}
                  className="flex items-center gap-1 border border-[#6d8a44] text-[#6d8a44] px-2 py-1 rounded-full text-[10px] font-semibold hover:bg-green-50"
                >
              ...
              <button 
                ...
                className="bg-white rounded-2xl shadow-md p-3 flex flex-col items-center justify-between aspect-square hover:bg-gray-50 cursor-pointer border border-transparent hover:border-[#6d8a44] transition-all"
              >
                <h3 className="text-xs font-bold text-gray-800 mt-1">Cultura Atual</h3>
                <span className="text-lg font-bold text-[#6d8a44] truncate w-full text-center">{culturaAtual}</span>
